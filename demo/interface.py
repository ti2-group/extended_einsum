...
intermediate_2 = xe.exp(xe.softmax(w))
result = xe.einsum("ij,jk->ik", intermediate_1, intermediate_2)
...
rich_program, input_arguments = xe.extract_program(result, stability_mode="logspace_max")
...
result_tensor_2 = run_program(backend_program, [x_new, w_new])
print(result_tensor_2)


# print(torch.max(torch.abs(result_tensor - result_tensor_2)))
